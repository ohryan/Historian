 ...
 */
import { camelCase, isEmpty, isObject, isString, mapKeys, pick, pickBy } from 'lodash';
/**
...
export function unstable__bootstrapServerSideBlockDefinitions(definitions) {
  for (const blockName of Object.keys(definitions)) {
    ...
    serverSideBlockDefinitions[blockName] = mapKeys(pickBy(definitions[blockName], value => value !== null && value !== undefined), (value, key) => camelCase(key));
  }
}
/**
