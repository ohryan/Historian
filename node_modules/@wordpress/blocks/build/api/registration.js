...
function unstable__bootstrapServerSideBlockDefinitions(definitions) {
  for (const blockName of Object.keys(definitions)) {
    ...
    serverSideBlockDefinitions[blockName] = (0, _lodash.mapKeys)((0, _lodash.pickBy)(definitions[blockName], value => value !== null && value !== undefined), (value, key) => (0, _lodash.camelCase)(key));
  }
}
/**
