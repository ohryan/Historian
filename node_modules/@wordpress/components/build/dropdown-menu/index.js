...
function DropdownMenu(dropdownMenuProps) {
  ...
  if ((0, _lodash.isEmpty)(controls) && !isFunction(children)) {
    return null;
  ...
  return (0, _element.createElement)(_dropdown.default, {
    ...
    renderContent: props => {
      ...
      return (0, _element.createElement)(_navigableContainer.NavigableMenu, (0, _extends2.default)({}, mergedMenuProps, {
        role: "menu"
      }), isFunction(children) ? children(props) : null, (0, _lodash.flatMap)(controlSets, (controlSet, indexOfSet) => controlSet.map((control, indexOfControl) => (0, _element.createElement)(_button.default, {
